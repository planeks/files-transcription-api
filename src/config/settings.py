...
PROJECT_NAME = config('PROJECT_NAME', default='files-transcriber')
...
AWS_PRESIGNED_EXPIRY = config("AWS_PRESIGNED_EXPIRY", default=10, cast=int)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@files-transcriber.com')
